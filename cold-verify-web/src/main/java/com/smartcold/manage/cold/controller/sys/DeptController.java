...
import com.smartcold.manage.cold.service.sys.DeptService;
import com.smartcold.manage.cold.util.Constant;
...
//	@RequiresPermissions("system:sysDept:remove")
	public R remove(Long deptId) {
		...
		if(sysDeptService.count(map)>0) {
			return R.newFailure(1, "包含下级部门,不允许修改");
		}
		if(sysDeptService.checkDeptHasUser(deptId)) {
			...
			return R.newFailure(1, "部门包含用户,不允许修改");
		}
		return R.newFailure();
	}
